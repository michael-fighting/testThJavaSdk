...
public class DagTransfer extends Contract {
    ...
    public TransactionReceipt userTransfer(String user_a, String user_b, BigInteger amount) {
        final Function function =
                new Function(
                        FUNC_USERTRANSFER,
                        Arrays.<Type>asList(
                                new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(user_a),
                                new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(user_b),
                                new org.tianhe.thbc.sdk.abi.datatypes.generated.Uint256(amount)),
    ...
    public Tuple2<BigInteger, BigInteger> userBalance(String user) throws ContractException {
        final Function function =
                new Function(
                        FUNC_USERBALANCE,
                        Arrays.<Type>asList(new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(user)),
                        Arrays.<TypeReference<?>>asList(
    ...
    public TransactionReceipt userAdd(String user, BigInteger balance) {
        final Function function =
                new Function(
                        FUNC_USERADD,
                        Arrays.<Type>asList(
                                new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(user),
                                new org.tianhe.thbc.sdk.abi.datatypes.generated.Uint256(balance)),
                        Collections.<TypeReference<?>>emptyList());
        return executeTransaction(function);
    }
