...
import org.tianhe.thbc.sdk.demo.perf.parallel.DagPrecompiledDemo;
import org.tianhe.thbc.sdk.demo.perf.parallel.ParallelOkDemo;
...
public class ParallelOkPerf {
    ...
    public static void Usage() {
        ...
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.tianhe.thbc.sdk.demo.perf.ParallelOkPerf [parallelok] [groupID] [add] [count] [tps] [file].");
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.tianhe.thbc.sdk.demo.perf.ParallelOkPerf [parallelok] [groupID] [transfer] [count] [tps] [file].");
        System.out.println("===== DagTransafer test===========");
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.tianhe.thbc.sdk.demo.perf.ParallelOkPerf [precompiled] [groupID] [add] [count] [tps] [file].");
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.tianhe.thbc.sdk.demo.perf.ParallelOkPerf [precompiled] [groupID] [transfer] [count] [tps] [file].");
    }
