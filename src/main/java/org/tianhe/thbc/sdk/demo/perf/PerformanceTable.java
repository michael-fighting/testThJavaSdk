...
import org.tianhe.thbc.sdk.demo.contract.TableTest;
...
public class PerformanceTable {
    ...
    private static void Usage() {
        ...
        System.out.println(
                " \t java -cp \'conf/:lib/*:apps/*\' org.tianhe.thbc.sdk.demo.perf.PerformanceTable [insert] [count] [tps] [groupId].");
        System.out.println(
                " \t java -cp \'conf/:lib/*:apps/*\' org.tianhe.thbc.sdk.demo.perf.PerformanceTable [update] [count] [tps] [groupId].");
        System.out.println(
                " \t java -cp \'conf/:lib/*:apps/*\' org.tianhe.thbc.sdk.demo.perf.PerformanceTable [remove] [count] [tps] [groupId].");
        System.out.println(
                " \t java -cp \'conf/:lib/*:apps/*\' org.tianhe.thbc.sdk.demo.perf.PerformanceTable [query] [count] [tps] [groupId].");
    }
