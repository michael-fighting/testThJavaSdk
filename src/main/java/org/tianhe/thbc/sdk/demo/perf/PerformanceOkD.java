...
import org.tianhe.thbc.sdk.demo.contract.OkD;
...
public class PerformanceOkD {
    ...
    private static void Usage() {
        ...
        System.out.println(
                " \t java -cp 'conf/:lib/*:apps/*' org.tianhe.thbc.sdk.demo.perf.PerformanceOkD [count] [tps] [groupId].");
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            OkD okd = OkD.deploy(client, client.getCryptoSuite().getCryptoKeyPair());
            System.out.println(
