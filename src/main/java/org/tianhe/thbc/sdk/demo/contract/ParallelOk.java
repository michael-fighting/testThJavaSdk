package org.tianhe.thbc.sdk.demo.contract;
...
import org.tianhe.thbc.sdk.abi.datatypes.generated.Uint256;
...
import org.tianhe.thbc.sdk.abi.datatypes.generated.tuples.generated.Tuple3;
...
public class ParallelOk extends Contract {
    ...
    public TransactionReceipt registerParallelFunction(
        ...
        final Function function =
                new Function(
                        ...
                        Arrays.<Type>asList(
                                new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(functionName),
                                new org.tianhe.thbc.sdk.abi.datatypes.generated.Uint256(
                                        criticalSize)),
    ...
    public BigInteger balanceOf(String name) throws ContractException {
        final Function function =
                new Function(
                        FUNC_BALANCEOF,
                        Arrays.<Type>asList(new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(name)),
    ...
    public TransactionReceipt set(String name, BigInteger num) {
        final Function function =
                new Function(
                        FUNC_SET,
                        Arrays.<Type>asList(
                                new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(name),
                                new org.tianhe.thbc.sdk.abi.datatypes.generated.Uint256(num)),
                        Collections.<TypeReference<?>>emptyList());
        return executeTransaction(function);
    }
    ...
    public TransactionReceipt transfer(String from, String to, BigInteger num) {
        final Function function =
                new Function(
                        FUNC_TRANSFER,
                        Arrays.<Type>asList(
                                new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(from),
                                new org.tianhe.thbc.sdk.abi.datatypes.Utf8String(to),
                                new org.tianhe.thbc.sdk.abi.datatypes.generated.Uint256(num)),
                        Collections.<TypeReference<?>>emptyList());
        return executeTransaction(function);
    }
    ...
    public static ParallelOk deploy(Client client, CryptoKeyPair credential)
            throws ContractException {
        return deploy(ParallelOk.class, client, credential, getBinary(client.getCryptoSuite()), "");
    }
}
